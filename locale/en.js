/*eslint-disable*/ module.exports = {
  messages: {
    ...
    '- 0.1 EWT to lock': '- 0.1 EWT to lock',
    ...
    'A portion of each trade (0.05%) goes to xSUSHI holders as a protocol incentive.':
      'A portion of each trade (0.05%) goes to xSUSHI holders as a protocol incentive.',
    'A portion of each trade (0.20%) goes CarbonPaws Treasury.':
      'A portion of each trade (0.20%) goes CarbonPaws Treasury.',
    'A portion of each trade (0.25%) goes CarbonPaws Treasury.':
      'A portion of each trade (0.25%) goes CarbonPaws Treasury.',
    ...
    'Audit or copy WDGAF': 'Audit or copy WDGAF',
    Auto: 'Auto',
    Available: 'Available',
    ...
    'Bridge tokens to and from the EnergyWeb Network': 'Bridge tokens to and from the EnergyWeb Network',
    'Bridge {0}': ['Bridge ', ['0']],
    ...
    Dismiss: 'Dismiss',
    Docs: 'Docs',
    'Documentation for CarbonPaws.io users': 'Documentation for CarbonPaws.io users',
    'Documentation for developers of Sushi.': 'Documentation for developers of Sushi.',
    'Documentation for users of CarbonPaws.': 'Documentation for users of CarbonPaws.',
    ...
    German: 'German',
    Github: 'Github',
    'Give me some EWT': 'Give me some EWT',
    'Go Back': 'Go Back',
    'Hardware Wallet': 'Hardware Wallet',
    'Harmony Bridge': 'Harmony Bridge',
    Harvest: 'Harvest',
    'Harvest {0} EWD': ['Harvest ', ['0'], ' EWD'],
    ...
    'Import it': 'Import it',
    'Import {0, plural, one {Token} many {Tokens}}': ['Import ', ['0', 'plural', { one: 'Token', many: 'Tokens' }]],
    'In Bento:': 'In Bento:',
    'In Wallet:': 'In Wallet:',
    ...
    'Please type the word "confirm" to {0} and lock your tokens for {1}.': [
      'Please type the word "confirm" to ',
      ['0'],
      ' and lock your tokens for ',
      ['1'],
      '.',
    ],
    Pool: 'Pool',
    ...
    'Remove liquidity of CarbonPaws': 'Remove liquidity of CarbonPaws',
    ...
    'Solar Vault is a set of high incentivized pools. Long term supporters can choose to lock EWD for a determined period for higher rewards.':
      'Solar Vault is a set of high incentivized pools. Long term supporters can choose to lock EWD for a determined period for higher rewards.',
    'Something went wrong during signing of the approval. This is expected for hardware wallets, such as Trezor and Ledger. Click again and the fallback method will be used':
      'Something went wrong during signing of the approval. This is expected for hardware wallets, such as Trezor and Ledger. Click again and the fallback method will be used',
    Soon: 'Soon',
    'Soon to be Raregems': 'Soon to be Raregems',
    Spanish: 'Spanish',
    ...
    'The output token cannot be transferred. There may be an issue with the output token.':
      'The output token cannot be transferred. There may be an issue with the output token.',
    'The participants receive various benefits such as higher rewards according to lock duration, higher allocations in Solar Launchpad and more.':
      'The participants receive various benefits such as higher rewards according to lock duration, higher allocations in Solar Launchpad and more.',
    ...
    "This token doesn't appear on the active token list(s). Make sure this is the token that you want to trade.":
      "This token doesn't appear on the active token list(s). Make sure this is the token that you want to trade.",
    'This token has recently launched! Be aware of high volatility and a potential of it being temporarily overbought. The launch price of this token is $0.05. It is ultimately your decision to invest.':
      'This token has recently launched! Be aware of high volatility and a potential of it being temporarily overbought. The launch price of this token is $0.05. It is ultimately your decision to invest.',
    'This transaction is below market rate': 'This transaction is below market rate',
    'This transaction will not succeed due to price movement. Try increasing your slippage tolerance to 2.1%!':
      'This transaction will not succeed due to price movement. Try increasing your slippage tolerance to 2.1%!',
    'This transaction will not succeed either due to price movement or fee on transfer. Try increasing your slippage tolerance to 2.1%!':
      'This transaction will not succeed either due to price movement or fee on transfer. Try increasing your slippage tolerance to 2.1%!',
    Timeframe: 'Timeframe',
    ...
    'Unknown error{0}. Try increasing your slippage tolerance to 2.1%!': [
      'Unknown error',
      ['0'],
      '. Try increasing your slippage tolerance to 2.1%!',
    ],
    ...
    'You are sending {currencyAmount} {0} from {1}': [
      'You are sending ',
      ['currencyAmount'],
      ' ',
      ['0'],
    ...
    'You will receive {currencyAmount} {0} on {1}': [
      'You will receive ',
      ['currencyAmount'],
      ' ',
      ['0'],
    ...
    'xSUSHI automatically earn fees (0.05% of all swaps, including multichain swaps) proportionalto your share of the SushiBar.':
      'xSUSHI automatically earn fees (0.05% of all swaps, including multichain swaps) proportional\nto your share of the SushiBar.',
    '{0, plural, one {Token} many {Tokens}}': [['0', 'plural', { one: 'Token', many: 'Tokens' }]],
    '{0}': [['0']],
    '{0} & Lock for {1}': [['0'], ' & Lock for ', ['1']],
    '{0} Deposited': [['0'], ' Deposited'],
    '{0} Strategy': [['0'], ' Strategy'],
    '{0} per {1}': [['0'], ' per ', ['1']],
    '{0} will lock your tokens for {1}.': [['0'], ' will lock your tokens for ', ['1'], '.'],
    '{0} {1} per {2}': [['0'], ' ', ['1'], ' per ', ['2']],
    '{0} {sign} market rate': [['0'], ' ', ['sign'], ' market rate'],
    '{0}/{1} Burned': [['0'], '/', ['1'], ' Burned'],
    '{0}/{1} CLP burned': [['0'], '/', ['1'], ' CLP burned'],
    '{label}': [['label']],
    '{title}': [['title']],
    '{v}': [['v']],
  },
