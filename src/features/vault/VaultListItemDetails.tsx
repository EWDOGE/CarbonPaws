...
import { EWD_DISTRIBUTOR_ADDRESS, EWD_VAULT_ADDRESS } from '../../constants/addresses'
...
const VaultListItem = ({ farm }) => {
  ...
  const [approvalState, approve] = useApproveCallback(typedDepositValue, EWD_VAULT_ADDRESS[chainId])
