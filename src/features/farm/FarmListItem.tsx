        ...
        <>
          ...
          >
            <div className="grid grid-cols-1 space-y-3">
              <div className="flex items-center justify-between space-x-4">
                ...
                <div className="flex flex-col justify-end text-right">
                  ...
                  {farm?.pair?.type === PairType.SWAP && (
                    <div className="text-xs md:text-base text-secondary">CarbonPaws LP</div>
                  )}
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between col-span-2 space-x-4 ">
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="font-bold text-righttext-high-emphesis">EWD</div>
                  </div>
                </div>
                <div className="flex items-center justify-between col-span-2 space-x-4">
              ...
              <div className="space-y-1">
                <div className="text-xs text-transparent md:text-base bg-clip-text bg-gradient-to-r from-yellow to-yellow">
                  EWD earned
                </div>
                <div className="flex items-center justify-between col-span-2 space-x-4">
                  <div className="flex flex-col justify-center">
