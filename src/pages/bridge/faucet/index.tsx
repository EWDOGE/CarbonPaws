...
export default function Faucet(): JSX.Element {
  ...
  return (
    <>
      <Head>
        <title>Faucet | CarbonPaws</title>
        <meta key="description" name="description" content="EnergyWeb Faucet" />
      </Head>
            ...
            <div className="h-[570px] flex flex-col justify-center items-center">
              <div className="p-4 mb-3 space-y-3 text-center">
                <Typography component="h1" variant="base">
                  A Faucet is a tool that provides a small amount of EWT for users that used the bridge to start using
                  CarbonPaws.io without having to buy EWT somewhere else.
                </Typography>
              </div>
              <div className="flex flex-1 justify-center text-center items-center mt-8 mb-12">
                <Image src="/images/faucet/ewc-faucet.png" alt="CarbonPaws" width={150} height={150} />
              </div>
              <div className="p-4 mb-3 space-y-1 text-center">
                <Typography component="h1" variant="base">
                  Faucet balance:{' '}
                  {formatNumberScale(tokenBalance[FAUCET_ADDRESS]?.toSignificant(4, undefined, 2) ?? 0, false, 4)} EWT
                </Typography>
                <Typography component="h1" variant="base">
