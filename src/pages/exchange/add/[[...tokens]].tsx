...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Add Liquidity`)} | CarbonPaws</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the CarbonPaws AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
      <CarbonPawsLogo />
