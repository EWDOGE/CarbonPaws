...
export default function Pool() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Pool`)} | CarbonPaws</title>
        <meta
          key="description"
          name="description"
          content="CarbonPaws liquidity pools are markets for trades between the two tokens, you can provide these tokens and become a liquidity provider to earn 0.25% of fees from trades."
        />
      </Head>
      <CarbonPawsLogo />
