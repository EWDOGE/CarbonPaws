...
export default function Vault(): JSX.Element {
  ...
  const valueStaked = positions.reduce((previousValue, currentValue) => {
    return previousValue + (currentValue.amount / 1e18) * ewdPrice
  }, 0)

  return (
    <>
      <Head>
        <title>Vaults | CarbonPaws</title>
                    ...
                    <div className={`hidden md:block`}>
                      <div className={`col-span-12 md:col-span-4 bg-dark-800 px-6 py-4 rounded`}>
                        ...
                        <div className="mb-4 text-base text-secondary">
                          <p>
                            {i18n._(
                              t`Solar Vault is a set of high incentivized pools. Long term supporters can choose to lock EWD for a determined period for higher rewards.`
                            )}
                          </p>
                          <p className="mt-2">
                            {i18n._(
