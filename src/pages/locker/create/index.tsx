...
export default function CreateLocker(): JSX.Element {
  ...
  return (
    <>
      <Head>
        <title>Locker | CarbonPaws</title>
        <meta key="description" name="description" content="CarbonPaws Locker" />
      </Head>
                ...
                <div className={`grid grid-cols-12 gap-4`}>
                  ...
                  <div className={`col-span-12 md:col-span-4 bg-dark-800 px-6 py-4 rounded`}>
                    ...
                    <div className="mb-4 text-base text-secondary">
                      ...
                      <p>{i18n._(t`- Locker contract address: ${LOCKER_ADDRESS[chainId || 246]}`)}</p>
