...
import { getNativeCurrency, JSBI, TokenAmount } from '@uniswap/sdk'
...
export default function Manage({
  ...
  const token = currencyA === nativeCurrency ? tokenB : tokenA
  const WETH = currencyA === nativeCurrency ? tokenA : tokenB
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          When you withdraw, the contract will automagically claim SUSU on your behalf!
        </TYPE.main>
