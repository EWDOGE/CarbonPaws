...
import { Currency, currencyEquals, Percent, WETH, getNativeCurrency } from '@uniswap/sdk'
                    ...
                    {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                      <RowBetween style={{ justifyContent: 'flex-end' }}>
                        {oneCurrencyIsETH ? (
                          <StyledInternalLink
                            to={`/remove/${
                              currencyA === getNativeCurrency(chainId) ? WETH[chainId].address : currencyIdA
                            }/${currencyB === getNativeCurrency(chainId) ? WETH[chainId].address : currencyIdB}`}
                          >
                          ...
                          >
                            Receive {getNativeCurrency(chainId).symbol}
                          </StyledInternalLink>
                        ) : null}
                      </RowBetween>
                    ) : null}
