...
import { Code, MessageCircle, Twitter, BookOpen, PieChart } from 'react-feather'
...
const CODE_LINK = 'https://github.com/carbonswap'
  ...
  return (
    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          {/*
          <MenuItem id="link" href="https://xxx/">
            <Info size={14} />
            About
          </MenuItem>
          ...
          <MenuItem id="link" href="https://bridge.carbonswap.exchange">
            <Repeat size={14} />
            Bridge
          </MenuItem>
          */}
