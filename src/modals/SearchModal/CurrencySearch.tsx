      ...
      {!currencyList && (
        <div className="mt-3 mb-8">
          <input
            ...
            className="w-full px-3 py-3 text-base font-bold bg-transparent border rounded border-dark-600 focus:border-dark-400 placeholder-secondary focus:placeholder-primary"
          />
        </div>
      )}
      {showCommonBases && (
